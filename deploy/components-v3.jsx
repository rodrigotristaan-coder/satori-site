...
function SatoriMark({ tail = " Agency", color = "#0E0E0E" }) {
  return <span style={{ color, whiteSpace: "nowrap" }}>Satori{tail}</span>;
}

// ---------- ENSŌ (drawn as arc with rough brush) ----------
function Enso({ size = 360, opacity = 0.92, spinning = true, color = "#A67C00" }) {
  // Recolor a black PNG: gold (#A67C00), white (light), or original black
  const c = (color || "").toLowerCase();
  let filter = "none";
  if (c === "#f4f4f2" || c === "#fff" || c === "#ffffff") {
    filter = "invert(1)";
  } else if (c !== "#0e0e0e" && c !== "#000" && c !== "#000000") {
    // Map black silhouette to gold #A67C00 via filter chain
    filter = "brightness(0) saturate(100%) invert(48%) sepia(85%) saturate(820%) hue-rotate(15deg) brightness(93%) contrast(99%)";
  }
  return (
    <div className="enso-host" style={{
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", marginBottom: "2.25rem" }}>
          <p style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.65rem", letterSpacing: "-0.01em", color: "#0E0E0E", margin: 0 }}><SatoriMark/></p>
  ...
  <h1 style={{
    ...
    color: "#0E0E0E", margin: 0, fontFamily: "serif"
      ...
      <span style={{ fontStyle: "italic", letterSpacing: "-2.4075px", fontWeight: "500", position: "relative", display: "inline-block", fontFamily: "\"DM Sans\"", fontSize: "78px" }}>
        <span style={{ color: "rgb(140, 140, 140)", fontWeight: "300", fontFamily: "-webkit-standard", textAlign: "center", fontSize: "58px" }}>{c.hero.h1b}</span>
    ...
    <section id="problema" style={{
      ...
      <div style={{ maxWidth: "62rem", margin: "0 auto" }}>
        ...
        <div style={{ marginTop: "3rem", display: "flex", alignItems: "center", gap: "1.5rem", flexWrap: "wrap" }}>
          <a href={WHATSAPP} target="_blank" rel="noopener" style={btnPrimary}>{c.problema.cta} →</a>
          <span style={{
...
function Ruta({ c }) {
  ...
  return (
    <div style={{ padding: "5rem clamp(1rem,4vw,3rem) 4rem", maxWidth: "78rem", margin: "0 auto" }}>
      <p style={{ ...eyebrowStyle, textAlign: "center", marginBottom: "3rem", fontSize: "18px" }}>{c.ruta.label}</p>
...
// ---------- SERVICIOS ----------
function Servicios({ c, layout, treatment }) {
  return (
    <section id="servicios" style={{
      ...
      <div style={{ padding: "7rem clamp(1.5rem,5vw,3rem) 5rem", maxWidth: "78rem", margin: "0 auto" }}>
        ...
        <p style={{ fontSize: "1.09rem", lineHeight: 1.7, color: "#0E0E0E", opacity: 0.55, fontWeight: 300, maxWidth: "32rem", marginTop: "1.25rem" }}>{c.servicios.sub}</p>
      </div>
          ...
          <div key={i} className="serv-stack" style={{
            ...
            padding: "3rem", alignItems: "center", borderRadius: "32px"
                ...
                <li key={bi} style={{ display: "flex", gap: "0.85rem", alignItems: "baseline" }}>
                  ...
                  <a href={`https://wa.me/525625018281?text=Hola%20Rodrigo,%20me%20interesa%20${encodeURIComponent(s.t)}`} target="_blank" rel="noopener" style={btnPrimary}>
                    {c.servicios.cta} →
                  </a>
                </div>
              </div>
          ...
          <div key={i} style={{
            ...
            border: "1px solid #0E0E0E12", borderRadius: "28px"
              ...
              <li key={bi} style={{ display: "flex", gap: "0.7rem", alignItems: "baseline" }}>
                ...
                <a href={`https://wa.me/525625018281?text=Hola%20Rodrigo,%20me%20interesa%20${encodeURIComponent(s.t)}`} target="_blank" rel="noopener" style={{ ...btnGhost, padding: "0.8rem 1.25rem", fontSize: "0.62rem" }}>
                  {c.servicios.cta} →
                </a>
              </div>
          )}
...
// ---------- FAQ ----------
function FaqItem({ q, a, last, first }) {
  ...
  return (
    <section style={{ padding: "7rem 1.5rem", borderTop: "1px solid #0E0E0E10", position: "relative", zIndex: 1 }}>
      <div style={{ maxWidth: "54rem", margin: "0 auto" }}>
        ...
        <div>
          {c.faq.items.map((f, i) => <FaqItem key={i} q={f.q} a={f.a} last={i === c.faq.items.length - 1} />)}
        </div>
      </div>
    </section>);
  ...
  return (
    <section id="cotizar" data-no-gold style={{
      ...
      <div style={{ maxWidth: "44rem", margin: "0 auto" }}>
        <div style={{ display: "flex", justifyContent: "center" }}>
          <Enso size={120} opacity={0.55} color="#A67C00" />
        </div>
        <h2 style={{
    ...
    <section id="cta-final" style={{
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: "42rem", margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", gap: "0.75rem", justifyContent: "center", flexWrap: "wrap" }}>
          <a href={wa} target="_blank" rel="noopener" style={btnGold}>{cta1} →</a>
          <a href={CALENDLY} target="_blank" rel="noopener" style={btnGhost}>{cta2}</a>
        </div>
      </div>
    </section>);
}
