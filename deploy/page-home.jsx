    ...
    >
      ...
      <style>{`
        @media (max-width: 900px) {
          .manifesto-logo img { height: 74px !important; }
        }
        @media (max-width: 560px) {
          .manifesto-logo img { height: 50px !important; }
        }
        @media (max-width: 380px) {
          .manifesto-logo img { height: 38px !important; }
        }
        /* Z Fold (~280px folded) */
        @media (max-width: 320px) {
          .manifesto-logo img { height: 31px !important; }
        }
