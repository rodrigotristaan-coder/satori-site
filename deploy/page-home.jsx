...
function BrandManifesto() {
  ...
  return (
    ...
    >
      ...
      >
        {/* logo SATORI — centrado, grande, estático (nudge -1cm para alinear el centro visual) */}
        <div
        ...
        >
          <div className="manifesto-logo-typewriter">
            <SatoriMark height={260} variant="gold" />
      ...
      <style>{`
        @media (max-width: 900px) {
          .manifesto-logo img { height: 180px !important; }
        }
        @media (max-width: 560px) {
          .manifesto-logo img { height: 120px !important; }
        }
  ...
  return (
    ...
    >
      <div className="container" style={{ textAlign: "center" }}>
        ...
        <div data-reveal style={{ maxWidth: "640px", margin: "0 auto" }}>
          <SatoriGlobe />
        </div>
      </div>
