...
const content = {
  es: {
    ...
    hero: {
      ...
      h1a: "Más estrategia",
      h1b: "Menos ruido.",
      sub: "Estrategia digital para empresarios que valoran su tiempo. Identidad, posicionamiento y marketing con IA.",
  ...
  en: {
    ...
    hero: {
      ...
      h1a: "More strategy",
      h1b: "Less noise.",
      sub: "Digital strategy for entrepreneurs who value their time. Identity, positioning and AI marketing.",
      cta1: "Free audit",
      cta2: "How it works"
    },
    problema: {
...
// ---------- SATORI WORDMARK (image logo) ----------
function SatoriMark({ color = "#0E0E0E", height = 44 }) {
  const dark = (color || "").toLowerCase() === "#f4f4f2" ||
               (color || "").toLowerCase() === "#fff" ||
               (color || "").toLowerCase() === "#ffffff";
  const src = dark ? "assets/logo-satori-agency-gold-dark.png" : "assets/logo-satori-agency-gold.png";
  return <img src={src} alt="Satori Agency" style={{ height: height + "px", width: "auto", display: "inline-block", verticalAlign: "middle" }} />;
}
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", marginBottom: "2.25rem", fontFamily: "\"DM Sans\"" }}>
          <p style={{ margin: 0, lineHeight: 0 }}><SatoriMark height={56} /></p>
        </div>
        ...
        <p style={{
          marginTop: "1.5rem", marginBottom: 0, textAlign: "center",
          fontSize: "0.72rem", lineHeight: 1.55, color: "#0E0E0E", opacity: 0.42,
          fontFamily: "\"DM Sans\"", fontWeight: 300
        }}>
          Al continuar aceptas nuestro{" "}
          <a href="privacidad.html" style={{ color: "#0E0E0E", opacity: 0.85, textDecoration: "underline", textDecorationThickness: "1px", textUnderlineOffset: "2px" }}>Aviso de Privacidad</a>.
          <br/>
          <span style={{ opacity: 0.85 }}>By continuing you accept our{" "}
            <a href="privacidad.html" style={{ color: "#0E0E0E", textDecoration: "underline", textDecorationThickness: "1px", textUnderlineOffset: "2px" }}>Privacy Notice</a>.
          </span>
        </p>
      </div>
    </div>);
...
function Nav({ c, lang, onLang, onOpenLang }) {
  return (
    <nav style={{
      ...
      <a href="#inicio" style={{ display: "inline-flex", alignItems: "center", textDecoration: "none", lineHeight: 0 }}><SatoriMark height={42} /></a>
...
function Hero({ c, layout }) {
  ...
  <h1 style={{
    fontWeight: 400,
    fontSize: "clamp(2.8rem, 11vw, 7rem)", lineHeight: 0.98, letterSpacing: "-0.025em",
    color: "#0E0E0E", margin: 0, fontFamily: "serif"
  }}>
      <span style={{ color: "#A67C00", fontWeight: 500 }}>{c.hero.h1a}</span><br />
      <span style={{ fontStyle: "italic", letterSpacing: "-0.025em", fontWeight: 300, position: "relative", display: "inline-block", fontFamily: "serif", fontSize: "clamp(1.6rem, 6.5vw, 4.2rem)", color: "rgb(140, 140, 140)" }}>
        {c.hero.h1b}
      </span>
    </h1>;
...
function Footer({ c }) {
  return (
    <footer style={{
      ...
      <span style={{ display: "inline-flex", alignItems: "center", lineHeight: 0 }}><SatoriMark color="#F4F4F2" height={44} /></span>
      <p style={{
        fontSize: "0.62rem",
