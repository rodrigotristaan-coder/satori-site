...
function AboutHero() {
  ...
  const c = lang === "en" ? {
    ...
    p2: "I have led 40+ simultaneous projects reporting directly to General Management, implemented continuous improvement methodologies, and operated every functional area of a business — marketing, sales, operations, HR and finance. SATORI is where all that learning lands at the service of entrepreneurs who value their time.",
    cta1: "Book Zoom",
    cta2: "Write me",
    find: "Find me",
    photoCaption: "Founder, SATORI",
    photoYear: "ACTIVE"
  } : {
    eyebrow: "Sobre mí",
    name: "Rodrigo",
    ...
    p2: "He liderado +40 proyectos simultáneos con reporte directo a Dirección General, implementado metodologías de mejora continua y operado cada área funcional de un negocio — marketing, ventas, operaciones, RRHH y finanzas. SATORI es donde todo ese aprendizaje aterriza al servicio de empresarios que valoran su tiempo.",
    cta1: "Agendar Zoom",
    cta2: "Escribirme",
    find: "Encuéntrame",
    photoCaption: "Fundador, SATORI",
        ...
        <div className="grid-2-inline" style={{ display: "contents" }}>
          <div className="fade-up">
            ...
            <div style={{ marginTop: "2.5rem", display: "flex", gap: "0.85rem", flexWrap: "wrap" }}>
              ...
              <a href="#contacto" className="cta-btn-ghost" style={btnGhost}>
                <span>{c.cta2}</span>
              </a>
            </div>
...
function Milestones() {
  ...
  const T = lang === "en" ? {
    eyebrow: "Trajectory",
    title: "A decade",
    accent: "doing marketing for real.",
    sub: "From agency floor to in-house operations to founder. A milestone-by-milestone read of how I got here."
  } : {
    eyebrow: "Trayectoria",
    title: "Una década",
    accent: "haciendo marketing de verdad.",
    sub: "De cancha en agencia a operación in-house a fundador. Un milestone a la vez, sin relleno."
  };
...
function InteractiveTimeline({ items }) {
  ...
  useEffect(() => {
    const onScroll = () => {
      ...
      // Range: from when section top hits 70% viewport to when bottom hits 30% viewport.
          ...
          >
            ...
            <div
              ...
              style={{
                ...
                borderRadius: "14px",
                background: isHover || isOpen ? `${SATORI.GOLD}08` : "transparent",
            ...
            >
              ...
              <div
                style={{
                  ...
                  left: "-7px",
                  top: "1.05rem",
                  width: isHover || isOpen ? "18px" : "14px",
                  height: isHover || isOpen ? "18px" : "14px",
                  borderRadius: "999px",
                  background: it.highlight ? SATORI.GOLD : SATORI.WHITE,
                  border: `2px solid ${it.highlight ? SATORI.GOLD : SATORI.INK}`,
              ...
              <div style={{ display: "flex", alignItems: "baseline", gap: "1rem", flexWrap: "wrap" }}>
                <h3
                  style={{
                    ...
                    lineHeight: 1.15,
                    margin: 0,
                    color: it.highlight ? SATORI.GOLD : SATORI.INK,
              ...
              <p
                style={{
                  ...
                  marginBottom: 0,
                  maxWidth: "60ch",
                  fontSize: isOpen ? "1rem" : "0.95rem",
                  color: isOpen ? SATORI.INK : `${SATORI.INK}B0`,
...
function ContactForm() {
  ...
  const c = lang === "en" ? {
    ...
    calendly_label: "CALENDLY · 30 MIN",
    calendly_link: "Open in new tab →",
    budgets: [
    ...
    method_wa: "WHATSAPP",
    method_zoom: "ZOOM",
    method_zoom_value: "Agendar 30 min",
    f_name: "Nombre",
    f_name_ph: "Tu nombre",
    f_company: "Empresa",
      ...
      <div className="container">
        ...
        >
          {[
            ...
            [c.method_zoom, c.method_zoom_value, SATORI.CALENDLY, "◷"]
        ...
        >
          ...
          >
            ...
            <CalendlyInline
              height={460}
              params="hide_gdpr_banner=1&hide_event_type_details=1&hide_landing_page_details=1&primary_color=a67c00&background_color=ffffff&text_color=0e0e0e"
            />
          </div>
        </div>
      </div>
