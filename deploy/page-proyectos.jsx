...
const PROYECTOS = [
  ...
  {
    titulo: "Bot en WhatsApp",
    cat: "Soluciones IA",
    year: "2025",
    descripcion: "Asistente conversacional que automatiza tu cuenta de WhatsApp: responde, agenda, califica leads y resume conversaciones largas en bullets accionables.",
    tags: ["WhatsApp Business", "Auto-responder", "Lead scoring"],
  ...
  {
    titulo: "Bot de Ventas para Redes Sociales",
    cat: "Soluciones IA",
    year: "2024",
