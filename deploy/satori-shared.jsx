...
function CtaBlock({ titulo = "Hablemos.", sub = "30 minutos. Sin compromiso. Salimos con claridad.", calendly = true }) {
  ...
  return (
    <section
      ...
      style={{
        padding: "7rem clamp(1.25rem,4vw,2.5rem) 7rem",
      ...
      <div style={{ maxWidth: "980px", margin: "0 auto", position: "relative", zIndex: 2 }}>
        ...
        <h2
          ...
          style={{
            ...
            margin: 0,
            color: SATORI.CREAM,
            backgroundImage: `linear-gradient(95deg, ${SATORI.CREAM} 0%, ${SATORI.CREAM} 42%, ${SATORI.GOLD} 50%, ${SATORI.CREAM} 58%, ${SATORI.CREAM} 100%)`,
