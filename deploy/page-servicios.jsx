      ...
      <div className="container">
        <div style={{ textAlign: "center", marginBottom: "4rem" }}>
          ...
          <h2 style={h2Style} data-reveal>
            Tres rutas. <span style={{ color: SATORI.GOLD }}>Una conversación.</span>
          </h2>
          <p style={{ ...bodyStyle, maxWidth: "52ch", margin: "1.25rem auto 0" }}>
            Sin términos a ciegas. Trabajamos mes a mes y la inversión se
            ajusta según el alcance real de cada proyecto.
          </p>
        </div>
        ...
        >
          ¿Necesitas algo distinto? <a href={SATORI.WHATSAPP} target="_blank" rel="noopener" style={{ color: SATORI.INK }}>Cotiza a medida</a>
        </p>
      </div>
    </section>
  );
...
function Faq() {
  const items = [
    {
      q: "¿Cuánto tarda en ver resultados?",
      a: "Marca propia: primeras semanas. Posicionamiento: 1–3 meses. Soluciones con IA: desde la activación."
    },
    {
      q: "¿Necesito saber de tecnología?",
      a: "Para nada. Nos encargamos de toda la parte técnica. Tú nos cuentas tu negocio, nosotros hacemos el resto."
    },
    {
      q: "¿Firmo contrato largo?",
      a: "No. Trabajamos mes a mes. Cancela cuando quieras, con 30 días de aviso."
    },
    {
      q: "¿Qué necesito para empezar?",
      a: "Una llamada de 30 minutos. Entendemos tu negocio, proponemos la ruta, te damos un precio claro."
    },
    {
      q: "¿Con qué tipo de negocios trabajan?",
      a: "Empresarios y pymes en México — despachos, constructoras, clínicas, consultoras y servicios profesionales."
    },
    {
      q: "¿Ofrecen garantía?",
      a: "30 días. Si no sientes que el valor supera la inversión, seguimos 20 días más sin costo. Sin preguntas."
    }
  ];
    ...
    >
      <div className="container-narrow">
        <div style={{ textAlign: "center", marginBottom: "3rem" }}>
          ...
          <h2 style={h2Style} data-reveal>
            Lo <span style={{ color: SATORI.GOLD }}>esencial.</span>
          </h2>
        </div>
        <div
          style={{
...
function App() {
  ...
  return (
    <main style={{ position: "relative", minHeight: "100vh", background: SATORI.CREAM }}>
      ...
      <Faq />
      <CtaBlock
        titulo="¿Listo para tu siguiente etapa?"
        sub="Empezamos con 30 minutos. Te digo qué paquete encaja y cómo lo activaríamos."
      />
