...
function Enso({ size = 360, opacity = 0.92, spinning = true, color = "#0E0E0E" }) {
  // color "#F4F4F2" or any non-black tint will be applied via CSS filter inversion
            ...
            borderBottom: "1px solid #0E0E0E15"
              ...
              color: "#0E0E0E", opacity: 0.25, fontStyle: "italic", lineHeight: 1
                ...
                letterSpacing: "-0.01em"
                  ...
                  <p style={{ fontSize: "0.95rem", lineHeight: 1.7, color: "#0E0E0E", opacity: 0.6, fontWeight: 300, maxWidth: "44rem" }}>{it.d}</p>
                </div>
              </div>
          )}
          </div> :
            ...
            padding: "1.75rem", border: "1px solid #0E0E0E12", background: "#0E0E0E03", borderRadius: "24px"
              ...
              letterSpacing: "0.15em", color: "#A67C00", opacity: 0.7, paddingTop: "0.4rem"
                ...
                fontWeight: 400, lineHeight: 1.3, marginBottom: "0.65rem", color: "#0E0E0E", fontSize: "28px"
                  ...
                  <p style={{ lineHeight: 1.7, color: "#0E0E0E", opacity: 0.6, fontWeight: 300, fontSize: "1px" }}>{it.d}</p>
                </div>
              </div>
          )}
          </div>
  ...
  return (
    <section id="servicios" style={{
      ...
      <div style={{ padding: "0 clamp(1.5rem,5vw,3rem) 7rem", maxWidth: "78rem", margin: "0 auto" }}>
        {layout === "stack" ?
        <div style={{ display: "flex", flexDirection: "column", gap: "1px", background: "#0E0E0E15" }}>
          ...
          <div key={i} className="serv-stack" style={{
            ...
            padding: "3rem", alignItems: "center", borderRadius: "32px"
                ...
                color: "#0E0E0E", opacity: 0.5, marginBottom: "1.5rem", fontWeight: 400
                  ...
                  <p style={{
                fontSize: "1.02rem", lineHeight: 1.65, color: "#0E0E0E", opacity: 0.7,
                ...
                <li key={bi} style={{ display: "flex", gap: "0.85rem", alignItems: "baseline" }}>
                        ...
                        <span style={{ fontSize: "0.92rem", color: "#0E0E0E", opacity: 0.78, fontWeight: 300 }}>{b}</span>
                      </li>
                )}
                  </ul>
...
function Footer({ c }) {
  return (
    <footer style={{
      ...
      <p style={{ fontFamily: "'Playfair Display', serif", letterSpacing: "-0.01em", fontSize: "28px" }}>Satori Agency</p>
      <p style={{
        fontFamily: "'JetBrains Mono', monospace", fontSize: "0.62rem",
